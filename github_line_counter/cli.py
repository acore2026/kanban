...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Count source lines across GitHub repos grouped by category topic."
    )
...
def main() -> int:
    ...
    if args.json:
        try:
            payload = collect_payload(args.owner, args.limit, args.workers)
    ...
    return serve_dashboard(args.owner, args.limit, args.workers, args.port)
